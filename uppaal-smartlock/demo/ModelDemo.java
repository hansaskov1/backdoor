...
public class ModelDemo
{
    ...
    public static UppaalSystem compile(Engine engine, Document doc) throws EngineException, IOException
    {
    ...
    public static ArrayList<SymbolicTransition> symbolicSimulation(Engine engine, UppaalSystem sys)
        ...
        while (state != null) {
            ...
            if (tr.getSize() == 0) {
                ...
                for (SystemEdge e : tr.getEdges()) {
                    System.out.print(e.getProcessName() + ": " + e.getEdge().getSource().getPropertyValue("name")
    ...
    public static void saveXTRFile(ArrayList<SymbolicTransition> trace, String file) throws IOException
    {
    ...
    public static QueryFeedback qf = new QueryFeedback() {
        ...
        @Override
        public void setTrace(char result, String feedback, ArrayList<SymbolicTransition> trace, int cycle,
